...
pub fn demo_of_rendering_stuff_with_context_that_allocates_in_the_background(draw_ctx: &DrawCtx, input_ctx: &InputCtx) -> bool {
    if input_ctx.key_pressed(KeyCode::Escape) {
        return true;
    }
    ...
    draw_text_line(draw_ctx, draw_ctx.window_width/2 + offset, draw_ctx.window_height/2, 16, second_text, 0xff0000);
